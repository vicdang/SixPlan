  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-surface-border bg-transparent shadow-sm hover:bg-surface-overlay text-text-primary',
        secondary: 'bg-surface-overlay text-text-secondary shadow-sm hover:bg-surface-border',
        ghost: 'hover:bg-surface-overlay hover:text-text-primary text-text-secondary',
